Feature: Add document equal to 10 MB as a attachment in the TR column in the pop up window that appears after clicking the Test steps column

Scenario: Add document equal to 10 MB as a attachment in the TR column in the pop up window 
