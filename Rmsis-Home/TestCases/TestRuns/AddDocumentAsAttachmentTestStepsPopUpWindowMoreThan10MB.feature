Feature: Add document greater than 10 MB as a attachment in the TR column in the pop up window that appears after clicking the Test steps column

Scenario: Add document greater than 10 MB as a attachment in the TR column in the pop up window 
