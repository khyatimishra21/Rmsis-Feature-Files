Feature: Add Document as attachment in unplanned requirement
   Add a document as attachment less than 10 MB in unplanned requirement

Scenario: Adding a document as attachment less than 10 MB in unplanned requirement
